...
| :--- | :--- | :--- |
| W://root/maintenance/decisions_ui | PENDING | UI에 Questions 탭 + Decide 모달 추가. DECISIONS/ 파일 생성과 WP.OPEN_QUESTIONS 자동 갱신 워크플로 구현 |
...
| W://root/test/test_dashboard | PENDING | Dashboard 테스트 (요소 통계, 상태 분포, 건강 경고) |
...
| W://root/maintenance/orphan_delete | PENDING | UI에서 WayPoint/Map 삭제 시 참조 없는 요소 자동 물리 삭제 로직 (orphan 방지) |
