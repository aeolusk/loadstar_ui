...
import { SquaresFour, CheckSquare, GitBranch, Scroll, Terminal, Info, Question, CalendarBlank, Target } from '@phosphor-icons/react';
...
const toolbarItems: { label: string; type: Tab['type']; icon: React.ReactNode }[] = [
  ...
  { label: 'Goals', type: 'goals', icon: <Target size={ICON_SIZE} /> },
];
