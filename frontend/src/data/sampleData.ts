    ...
    children: [
      {
        ...
        children: [
          { address: 'W://root/backend/project_config', type: 'WAYPOINT', status: 'S_STB', summary: 'Project Config', children: [
            { address: 'B://root/backend/project_config', type: 'BLACKBOX', status: 'S_STB', summary: 'Project Config BB', children: [] },
          ]},
          { address: 'W://root/backend/element_service', type: 'WAYPOINT', status: 'S_PRG', summary: 'Element Service', children: [
            { address: 'B://root/backend/element_service', type: 'BLACKBOX', status: 'S_PRG', summary: 'Element Service BB', children: [] },
          ]},
          { address: 'W://root/backend/todo_service', type: 'WAYPOINT', status: 'S_IDL', summary: 'TODO Service', children: [
            { address: 'B://root/backend/todo_service', type: 'BLACKBOX', status: 'S_IDL', summary: 'TODO Service BB', children: [] },
          ]},
          { address: 'W://root/backend/git_service', type: 'WAYPOINT', status: 'S_IDL', summary: 'Git Service', children: [
            { address: 'B://root/backend/git_service', type: 'BLACKBOX', status: 'S_IDL', summary: 'Git Service BB', children: [] },
          ]},
          { address: 'W://root/backend/monitor_service', type: 'WAYPOINT', status: 'S_IDL', summary: 'Monitor Service', children: [] },
          { address: 'W://root/backend/log_service', type: 'WAYPOINT', status: 'S_IDL', summary: 'Log Service', children: [] },
      ...
      },
      {
        ...
        children: [
          { address: 'W://root/frontend/app_shell', type: 'WAYPOINT', status: 'S_PRG', summary: 'App Shell', children: [
            { address: 'B://root/frontend/app_shell', type: 'BLACKBOX', status: 'S_PRG', summary: 'App Shell BB', children: [] },
          ]},
          { address: 'W://root/frontend/map_view', type: 'WAYPOINT', status: 'S_IDL', summary: 'Map View', children: [] },
          { address: 'W://root/frontend/waypoint_editor', type: 'WAYPOINT', status: 'S_IDL', summary: 'WayPoint Editor', children: [] },
          { address: 'W://root/frontend/blackbox_editor', type: 'WAYPOINT', status: 'S_IDL', summary: 'BlackBox Editor', children: [] },
          { address: 'W://root/frontend/dashboard', type: 'WAYPOINT', status: 'S_IDL', summary: 'Dashboard', children: [] },
          { address: 'W://root/frontend/todo_view', type: 'WAYPOINT', status: 'S_IDL', summary: 'TODO View', children: [] },
          { address: 'W://root/frontend/monitor_view', type: 'WAYPOINT', status: 'S_IDL', summary: 'Monitor View', children: [] },
          { address: 'W://root/frontend/git_view', type: 'WAYPOINT', status: 'S_IDL', summary: 'Git View', children: [] },
          { address: 'W://root/frontend/log_view', type: 'WAYPOINT', status: 'S_IDL', summary: 'Log View', children: [] },
          { address: 'W://root/frontend/cli_console', type: 'WAYPOINT', status: 'S_IDL', summary: 'CLI Console', children: [] },
          { address: 'W://root/frontend/search', type: 'WAYPOINT', status: 'S_IDL', summary: 'Search', children: [] },
        ],
      },
    ],
  },
